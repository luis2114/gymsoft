...
public class elimins extends JFrame {
	...
	public elimins() {
		...
		button_1.setBounds(259, 85, 89, 23);
		contentPane.add(button_1);
		
		JLabel lblIdInstructor = new JLabel("Id instructor");
		lblIdInstructor.setBounds(48, 86, 89, 21);
		contentPane.add(lblIdInstructor);
		
		textField = new JTextField();
		textField.setColumns(10);
		textField.setBounds(129, 86, 86, 20);
